...
folders <- c(str_sort(folders), "emisc")
...
```{r include=FALSE}
folders2 <- paste0("[`", folders,
                   "`](https://docs.evanodell.com/", folders, ")")

license <- c()

for (i in seq_along(folders)) {
y <- xml2::read_xml(paste0("https://img.shields.io/github/license/evanodell/",
                           folders[[i]]))

if(grepl("not identifiable by github", y)) {
  license[i] <- paste0("[![license](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/EvanOdell/", folders[[i]], "blob/master/LICENSE.md)")
  } else {
...
cran_status <- paste0(
  "[![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/", folders,
  ")](https://cran.r-project.org/package=", folders, ")")

github_status <- paste0(
  "[![GitHub tag](https://img.shields.io/github/tag/evanodell/", folders,
  ".svg)](https://github.com/evanodell/", folders, ")")

downloads <- paste0(
  "[![](https://cranlogs.r-pkg.org/badges/grand-total/", folders,
  ")](https://cran.r-project.org/package=", folders, ")")
