...
build_emisc <- function() {
  ...
  base_files <- paste0("/Users/evanodell/Documents/Code/packages/emisc/", list.files(path = "/Users/evanodell/Documents/Code/packages/emisc",
                                                                                     recursive = TRUE))
  ...
  web_files <- paste0("emisc/", list.files(path = "emisc",
                                           recursive = TRUE))
