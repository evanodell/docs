...
build_hansard <- function() {
  ...
  base_files <- paste0("/Users/evanodell/Documents/Code/packages/hansard/", list.files(path = "/Users/evanodell/Documents/Code/packages/hansard",
                                                                                       recursive = TRUE))
  ...
  web_files <- paste0("hansard/", list.files(path = "hansard",
                                             recursive = TRUE))
