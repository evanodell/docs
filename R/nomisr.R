...
build_nomisr <- function() {
  ...
  base_files <- paste0("/Users/evanodell/Documents/Code/packages/nomisr/",
                       list.files(path = "/Users/evanodell/Documents/Code/packages/nomisr",
                                  recursive = TRUE))
  ...
  web_files <- paste0("nomisr/", list.files(path = "nomisr",
                                            recursive = TRUE))
